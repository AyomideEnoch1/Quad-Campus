        ...
        <View style={styles.modalCard}>
          ...
          <ScrollView contentContainerStyle={styles.formContent}>
            ...
            <TouchableOpacity onPress={pickBanner} style={styles.bannerPicker}>
              <Image source={{ uri: bannerUrl || 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&auto=format&fit=crop&q=80' }} style={styles.bannerImg} />
            ...
            <View style={styles.avatarRow}>
              <TouchableOpacity onPress={pickAvatar} style={styles.avatarPicker}>
                <Image source={{ uri: avatarUrl || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&auto=format&fit=crop&q=80' }} style={styles.avatarImg} />
